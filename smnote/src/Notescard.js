...
<div className={`notes ${this.props.active_id===this.props.data._id&&"active"}`} onClick={this.setactive.bind(this) }  >


      {!this.props.data.pinned?(
    
            <GradeOutlinedIcon className="star" onClick={this.setpinned.bind(this)} /> 
    ...
    <div className="card">
           ...
           <small className="note-meta ">Last Modify :- 
